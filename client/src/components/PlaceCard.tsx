  ...
  return (
    ...
    >
      <Link href={`/places/${place.id}`} className="block h-full group">
        <article className="h-full bg-card rounded-2xl border border-border/50 p-5 shadow-sm hover:shadow-lg hover:shadow-black/5 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
          <div>
